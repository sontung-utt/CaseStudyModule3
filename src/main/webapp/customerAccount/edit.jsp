...
<div class="container">
    ...
    <div class="form">
        ...
        <% } %>
        <form action="http://localhost:8080/accCustomers?action=edit" method="post">
            <table border="1">
                <tr>
                    <th colspan="2">SỬA THÔNG TIN TÀI KHOẢN</th>
                </tr>
                <tr>
                    <td class="info">
                ...
                <tr>
                    ...
                    <td><input type="text" name="username" id="username" value="${customerAccount.username}"></td>
                </tr>
                <tr>
                    <td class="info">
