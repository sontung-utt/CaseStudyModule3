...
<div class="container">
    ...
    <div class="form">
        ...
        <% } %>
        <form action="http://localhost:8080/departments?action=add" method="post">
            <table border="1">
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="salaryCoefficient" id="salaryCoefficient"></td>
                </tr>
                <tr>
                    <td colspan="2" class="tdbtn">
                        <a href=""><button>Thêm chức năng</button></a>
                    </td>
                </tr>
            </table>
        </form>
