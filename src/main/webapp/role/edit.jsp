...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/addRole.css?v=1.0'/>">
...
<div class="container">
    ...
    <div class="form">
        ...
        <% } %>
        <form action="http://localhost:8080/role?action=edit" method="post">
            <table border="1">
                <tr>
                    <th colspan="2">SỬA THÔNG TIN CHỨC NĂNG</th>
                </tr>
                <tr>
                    <td class="info">
                        <i class="fa-solid fa-list-ol"></i>
                        <label for="id">Mã chức năng</label>
                    </td>
                    <td><input type="text" name="id" id="id" value="${role.id}" readonly></td>
                </tr>
                <tr>
                    <td class="info">
